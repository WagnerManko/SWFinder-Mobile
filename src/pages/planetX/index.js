    ...
    return (
        <ScrollView style={style.viewBody}>
            ...
            <View style={style.viewDetails}>
                ...
                <Text style={style.itemText}>Diameter: <Text style={style.itemData}>{planet.diameter}</Text></Text>
                <Text style={style.itemText}>Rotation Period: <Text style={style.itemData}>{planet.rotation_period}</Text></Text>
                <Text style={style.itemText}>Orbital Period: <Text style={style.itemData}>{planet.orbital_period}</Text></Text>
            </View>
            <View style={style.viewDetails}>
