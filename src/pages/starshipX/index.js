    ...
    return (
        <ScrollView style={style.viewBody}>
            ...
            <View style={style.viewDetails}>
                ...
                <Text style={style.itemText}>Max Speed: <Text style={style.itemData}>{starship.max_atmosphering_speed}</Text></Text>
            ...
            <View style={style.viewDetails}>
                ...
                <Text style={style.itemText}>Length: <Text style={style.itemData}>{starship.length}</Text></Text>
                ...
                <Text style={style.itemText}>Cargo Capacity: <Text style={style.itemData}>{starship.cargo_capacity}</Text></Text>
            </View>        
        </ScrollView>
    )
}